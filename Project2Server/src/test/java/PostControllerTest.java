...
//    private UserController userController;
  ...
  public void shouldCreatePost() throws Exception{
    ...
    ResultActions result = mockMvc.perform(post("/post/create")
      .contentType(MediaType.APPLICATION_JSON_VALUE)
      .content(asJsonString(new Post(40, user, "nope post", Date.valueOf(LocalDate.now()), Time.valueOf(LocalTime.now()),null, false)))
      .accept(MediaType.APPLICATION_JSON))
      .andExpect(status().isOk());
  }
  ...
  public void shouldCreateComment() throws Exception {
    ...
    ResultActions result = mockMvc.perform(post("/comment/create")
      .contentType(MediaType.APPLICATION_JSON_VALUE)
      .content(asJsonString(new Comment(8,post,user,"OMG THIS IS SO QUIRKY",Date.valueOf(LocalDate.now()), Time.valueOf(LocalTime.now()))))
      .accept(MediaType.APPLICATION_JSON))
      .andExpect(status().isOk());
...
//    user.setPassword(45);
    ...
    user.setEmail("billiam@gmail.com");
//    user.setDisplayName("lolol");
    post.setId(4);
    MvcResult result=mockMvc.perform(post("/like/create")
      .contentType(MediaType.APPLICATION_JSON_VALUE)
...
//    user.setEmail("bob@nope.com");
//    user.setDisplayName("lol");
//    post.setId(59);
//    MvcResult result=mockMvc.perform(post("/like/create")
//      .contentType(MediaType.APPLICATION_JSON_VALUE)
//      .content(asJsonString(new Like(post,user))))
